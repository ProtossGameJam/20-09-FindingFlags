...
public class Bubble : MonoBehaviour
{
    ...
    protected static void SetFitSize(SpriteRenderer bubbleRenderer, Vector2 contentSize, Vector2 padding,
        bool isReversed) {
        bubbleRenderer.size = contentSize + padding;
        bubbleRenderer.flipX = isReversed;
    }

    protected static void SetCenterPos(Transform bubbleTransform, Vector2 pivot, Vector2 bubbleSize, float tailFixPos,
        bool isReversed) {
